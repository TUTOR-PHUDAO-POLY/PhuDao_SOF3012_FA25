package com.sof3012.main.B2_CRUD_P2.util;
...
public class HibernateUtil {
    ...
    static {
        ...
        conf.addAnnotatedClass(BaiHat.class); // Dang ky su dung o day
        conf.addAnnotatedClass(CaSi.class); // Dang ky su dung o day
